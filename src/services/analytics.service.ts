...
export const adminAnalytics = {
  ...
  // Módulos por cliente (nome+status) — alimenta o card "Módulos entregues" (entregues x contratados)
  // e o painel "Módulos por cliente". Fonte: delivery.client_modules JOIN catalog.vdi_modules.
  modulesByClient: <T = any[]>() => rpc<T>("admin_modules_by_client"),
  ...
  healthCheck: <T = any>() => rpc<T>("admin_health_check"),
