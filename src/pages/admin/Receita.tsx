  ...
  return (
    <div className="receitapage">
      ...
      <div className="kpis">
        ...
        <div className="kpi g"><div className="lab">Lucro estimado</div><div className="val tnum">{money(o?.profit ?? 0)}</div><div className="delta">após impostos {fmtRate(taxRate)}%</div></div>
