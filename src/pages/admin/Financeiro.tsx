      ...
      {!loading && (<>
        ...
        <div style={{ marginBottom: 10 }}>
          ...
          <div className="kpis">
            ...
            <button className="kpi kpi-btn" onClick={() => setDrill({ title: t("A vencer"), rows: cobDrill("avencer"), foot: { label: t("A vencer"), value: cobSum("avencer") } })}><div className="lab">{t("A vencer")}</div><div className="val tnum" style={{ fontSize: 18 }}>{cobCount("avencer")}</div><div className="delta">{t("parcela(s)")}</div></button>
