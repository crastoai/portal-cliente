...
export default function Catalogo() {
  ...
  async function recomendar() {
    ...
    } catch (e) { setRecoErr(errorMessage(e)); } finally { setRecoBusy(false); }
  }
  ...
  return (
    <div>
      ...
      {/* ═══ AMPLIE SUA OPERAÇÃO ═══ recomendador de IA (DeepSeek) — sem preço, termina em reunião. */}
      <div style={{ background: "linear-gradient(150deg,var(--crasto-navy,#010E26),#000714)", color: "#fff", borderRadius: "var(--crasto-radius-lg,20px)", padding: "22px", marginBottom: 20 }}>
