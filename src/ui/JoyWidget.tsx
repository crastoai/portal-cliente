...
const KB: Kb[] = [
  ...
  { id: "tarefas", q: "Onde vejo minhas tarefas / a Minha Mesa?", keywords: "tarefas mesa minha mesa afazeres to-do pendências ligações lembrete follow-up do dia",
  ...
  { id: "cockpit", q: "O que é o Cockpit / a tela inicial?", keywords: "cockpit início inicio home tela inicial resultados números kpi indicadores visão geral painel meus resultados",
  ...
  { id: "agenda", q: "Como agendo uma reunião / vejo os agendamentos?", keywords: "agenda agendamento agendamentos agendar reunião reuniao compromisso calendário calendario marcar horário horario visita call encontro data",
    a: ["Em Vendas → Agendamentos você vê e cria compromissos (reuniões, visitas, calls) ligados aos seus leads. Escolha a data/horário e vincule ao contato — assim ninguém perde o combinado."] },
  { id: "contatos", q: "Onde ficam os meus contatos?", keywords: "contatos contato lista pessoas telefone número numero cadastro base whatsapp agenda de contatos",
    a: ["Em Vendas → Contatos fica a lista de contatos do WhatsApp. Clique num contato pra ver o histórico e abrir a conversa. Pra trazer uma lista de fora, use a Importação dentro do CRM."] },
  { id: "config", q: "Como configuro o meu agente de IA?", keywords: "configurações configuracoes configurar agente ia personalidade tom voz mensagem saudação saudacao horário horario atendimento comportamento ajustar treinar prompt regras",
    a: ["Em Vendas → Configurações você ajusta o agente de IA: identidade/nome, mensagem de saudação, horário de atendimento, quebra de mensagens e outros comportamentos. As mudanças valem para as próximas conversas."] },
  { id: "dashboard", q: "O que tem no Dashboard de Vendas?", keywords: "dashboard painel vendas números numeros métricas metricas resultados gráfico grafico taxa resposta conversão conversao receita indicadores",
    a: ["Em Vendas → Dashboard você vê os números do funil: leads por etapa, taxa de resposta, conversão e receita — a leitura rápida de como as vendas estão indo. Dá pra filtrar por período e vendedor."] },
  { id: "etapas", q: "O que significa cada etapa do funil?", keywords: "etapa etapas funil coluna significado o que é novo template enviado lead oportunidade convertido vendido descartado prospecto fase estágio estagio",
    a: ["Novo = lead cru, sem contato ainda. Template enviado = já mandamos a 1ª mensagem. Lead = respondeu/engajou. Oportunidade = tem proposta na mesa. Convertido = virou venda. Descartado = não seguiu."] },
  { id: "valor", q: "Como registro o valor de uma proposta ou venda?", keywords: "valor proposta venda ticket receita registrar oportunidade convertido preço preco quanto fechou faturamento montante",
    a: ["Ao mover um lead para Oportunidade ou Convertido, o sistema pede o valor (R$). É esse número que alimenta ‘propostas na mesa’, ticket médio e receita. Dá pra editar depois clicando no card."] },
  { id: "lista", q: "Como uso a visão em Lista dos leads?", keywords: "lista tabela ordenar colunas ações em massa selecionar marcar filtrar exportar visão coluna editar célula bloco cards alternar",
    a: ["No quadro de leads, alterne para a visão Lista (ícone no topo). É uma tabela ordenável por clique, com colunas personalizáveis (⚙), ações em massa (marque linhas → mover etapa / atribuir vendedor / excluir) e edição direta clicando na célula."] },
  { id: "modulos", q: "O que é um módulo com cadeado?", keywords: "módulo modulo módulos cadeado bloqueado bloqueio indisponível indisponivel contratar ativar liberar comercial trancado fechado",
    a: ["Um item com cadeado é um módulo que a sua empresa ainda não contratou. Ao clicar, aparece um aviso: para ativar o conteúdo, fale com o seu representante comercial da Crasto.AI."] },
  { id: "solucoes", q: "Onde vejo o que já contratei (Minhas Soluções)?", keywords: "minhas soluções solucoes solução contratado ativo produtos meus módulos catálogo catalogo o que tenho",
    a: ["Em Minhas Soluções (grupo Minha Crasto.AI) ficam os produtos que você contratou, com o status de cada um. O Catálogo de soluções mostra o que dá pra contratar a mais."] },
  { id: "implementacao", q: "Como acompanho a implantação do meu projeto?", keywords: "implementação implementacao implantação implantacao onboarding progresso andamento status entrega projeto quando fica pronto começar",
    a: ["Enquanto a sua implantação não termina, aparece ‘Minha Implementação’ no menu, com o progresso e as etapas. Quando chega a 100%, ela some — sinal de que já está tudo entregue."] },
  { id: "notificacoes", q: "O que é o sininho de notificações?", keywords: "sininho sino notificação notificações notificacoes aviso avisos alerta novidade som badge topo bell contador",
    a: ["O sininho no topo mostra novidades: chamados respondidos, tarefas novas, leads pra ligar e avisos do sistema. O número no ícone é quantas você ainda não viu."] },
  { id: "horas", q: "Como funciona o meu plano de horas de suporte?", keywords: "horas hora suporte plano saldo chamado consumo mensal contratar extra melhorias esgotou acabou",
    a: ["Você tem um plano de horas de suporte por mês. ‘Suporte do Agente’ (manter no ar, corrigir erros) entra no plano; ‘Melhorias’ são orçadas à parte. Se as horas acabarem, dá pra contratar extras ou aguardar o próximo mês."] },
  { id: "tema", q: "Como troco o tema (claro/escuro) ou o idioma?", keywords: "tema claro escuro dark mode modo noturno idioma língua lingua português portugues inglês ingles trocar aparência aparencia cor",
    a: ["No topo, à direita, ficam os botões de tema (claro/escuro) e de idioma. No celular, eles ficam dentro do menu do seu perfil (no avatar)."] },
  ...
  { id: "buscar", q: "Como encontro um lead ou contato específico?", keywords: "buscar procurar pesquisar encontrar achar filtro nome telefone lead contato localizar cidade segmento onde está",
    a: ["Use o campo de busca no topo do CRM (nome, telefone, cidade ou segmento) e os filtros de etapa e vendedor. Na visão Lista, dá pra ordenar por qualquer coluna pra achar mais rápido."] },
